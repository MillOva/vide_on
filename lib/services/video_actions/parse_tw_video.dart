...
//
//     final twitchVideo = twitchVideoFromJson(jsonString);

import 'dart:convert';

TwitchVideo twitchVideoFromJson(String str) => TwitchVideo.fromJson(json.decode(str));

String twitchVideoToJson(TwitchVideo data) => json.encode(data.toJson());
...
class TwitchVideo {
  ...
  factory TwitchVideo.fromJson(Map<String, dynamic> json) => TwitchVideo(
...
class Channel {
  ...
  dynamic profileBannerBackgroundColor;
  String status;
  DateTime updatedAt;
  String url;
  String videoBanner;
